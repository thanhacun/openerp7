    ...
    load_views: function() {
        ...
        _.each(modes, function(mode) {
            ...
            if(view.view_type === "list") {
            	if ((typeof self.node.attrs.limit === "undefined") && (typeof self.options.limit === "undefined")) 
            		kderp_limit = 5;
            	else
            		if (typeof self.node.attrs.limit === "undefined")
            			kderp_limit =  parseInt(self.options.limit,10);
            		else
            			kderp_limit =  parseInt(self.node.attrs.limit,10);
