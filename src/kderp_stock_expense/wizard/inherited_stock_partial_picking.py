...
class stock_partial_picking(osv.osv_memory):
    ...
    def _partial_move_for(self, cr, uid, move, context=None):
        partial_move = {
            ...
            'move_id' : move.id,
            'location_id' : move.location_id.id if move.location_id else move.picking_id.location_id.id,
            'location_dest_id' : move.location_dest_id.id if move.location_dest_id else move.picking_id.location_id.id,
