-- #####################KDERP LOCATION#################
-- insert into 
-- 	kderp_location (id,city,code,name)
-- Select
-- 	id,
-- 	create_uid,
-- 	create_date,
...
-- 	code varchar(4),
-- 	name varchar(100))
-- --Select max(id) from kderp_location --24
-- --alter SEQUENCE kderp_location_id_seq RESTART with 25
-- 
...
--Select max(id) from kderp_contract_client --1336
--alter SEQUENCE kderp_contract_client_id_seq RESTART with 1337
...
-- Select max(id) from kderp_contract_currency; --3945
-- alter SEQUENCE kderp_contract_currency_id_seq RESTART with 4122
-- Select * from kderp_contract_currency ;
...
-- Select max(id) from kderp_client_payment_term; --1585
-- alter SEQUENCE kderp_client_payment_term_id_seq RESTART with 1586
...
-- Select max(id) from kderp_progress_evaluation; --1628
-- alter SEQUENCE kderp_progress_evaluation_id_seq RESTART with 1629