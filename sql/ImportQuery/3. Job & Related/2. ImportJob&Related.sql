...
-- Select max(id) from account_analytic_account -- 804
-- alter SEQUENCE account_analytic_account_id_seq RESTART with 805
...
-- --Select max(id) from kderp_job_currency --3933
-- --alter SEQUENCE kderp_job_currency_id_seq RESTART with 4126
...
-- --Select max(id) from kderp_budget_history --1722
-- --alter SEQUENCE kderp_budget_history_id_seq RESTART with 1723
...
--Select max(id) from kderp_budget_data --11688
--alter SEQUENCE kderp_budget_data_id_seq RESTART with 11689