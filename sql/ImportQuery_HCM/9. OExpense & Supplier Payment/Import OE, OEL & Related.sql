...
-- Select max(id) from kderp_other_expense --15289
-- alter SEQUENCE kderp_other_expense_id_seq RESTART with 15290
...
-- 	)
	...
	-- IMPORT PURCHASE TAX
-- delete from other_expense_vat_tax
...
-- Select max(id) from kderp_other_expense_line --38051
-- alter SEQUENCE kderp_other_expense_line_id_seq RESTART with 38052
