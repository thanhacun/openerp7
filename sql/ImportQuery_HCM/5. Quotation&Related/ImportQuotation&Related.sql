...
-- Select max(id) from sale_order --10263
-- alter SEQUENCE sale_order_id_seq RESTART with 10264
...
-- Select max(id) from kderp_sale_order_submit_line --3473
-- alter SEQUENCE kderp_sale_order_submit_line_id_seq RESTART with 3474
